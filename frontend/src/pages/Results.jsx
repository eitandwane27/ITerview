    ...
    return (
      <div className="rs-bar-row">
        <div className="rs-bar-label">
          ...
          <span className="rs-bar-value" style={{ color: 'var(--text-muted)' }}>
            Not assessed
          </span>
        </div>
    ...
    <div className="rs-bar-row">
      <div className="rs-bar-label">
        ...
        <span className="rs-bar-value">
          {value.toFixed(1)}
          <span className="rs-bar-max">/{max}</span>
        </span>
      </div>
    ...
    <div className={`rs-set-chip ${completed ? '' : 'rs-set-chip--incomplete'}`}>
      ...
      <div className="rs-set-chip-body">
        ...
        {completed && score !== null ? (
          <span className="rs-set-chip-score">
            {animated}/{outOf}
          </span>
        ) : (
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      try {
        ...
        setError(
          'Unable to retrieve interview results. Please ensure you have completed the sessions.'
        );
      } finally {
        setLoading(false);
      }
    ...
    return (
      <div className="rs-root">
        <header className="rs-topbar">
          <div className="rs-topbar-brand">ITerview</div>
          <span
            className="rs-topbar-badge"
            style={{ background: 'var(--color-badge-red-bg)', color: 'var(--color-badge-red)' }}
          >
            Error
          </span>
        </header>
        ...
        >
          ...
          >
            ...
            <p style={{ margin: '1rem 0', color: 'var(--text-muted)' }}>
              {error ||
                'Make sure you complete both the pre-test, intermediate practice sets, and post-test sessions.'}
            </p>
            <button
    ...
    <div className="rs-root">
      ...
      {data.unlocked && (
        <div className="rs-unlock-banner" role="alert" aria-live="polite">
          ...
          <div>
            <strong>Level Unlocked!</strong> You cleared the {data.unlockThreshold}% threshold and
            unlocked <em>{data.nextDifficulty}</em> difficulty.
          </div>
        </div>
      )}
      ...
      <main className="rs-main">
        ...
        {!isPracticeMode && (
          <section className="rs-card rs-hero-card" aria-labelledby="hero-heading">
            <div className="rs-card-header">
              ...
              <h2 id="hero-heading" className="rs-card-title">
                Confidence Growth
              </h2>
            </div>
        ...
        <section className="rs-card" aria-labelledby="mastery-heading">
          ...
          <div className="rs-inner-card">
            ...
            {!isPracticeMode && (
              <>
                <div
                  className="rs-performance-compare"
                  style={{
                    display: 'flex',
                    gap: '16px',
                    marginTop: '12px',
                ...
                >
                  ...
                  <div className="rs-conf-pill rs-conf-pill--after">
                    ...
                    <span
                      className="rs-conf-pill-value"
                      style={{ color: 'var(--color-badge-green)' }}
                    >
        ...
        <section className="rs-card" aria-labelledby="star-heading">
          <div className="rs-card-header">
            ...
            <h2 id="star-heading" className="rs-card-title">
              Set 3 · STAR Breakdown
            </h2>
          </div>
